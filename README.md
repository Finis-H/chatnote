...
| 截图 | 说明 | 状态 |
|---|---|---|
| `docs/assets/screenshots/01-home-command-console.png` | 首页工作台与 Command Console | TODO |
| `docs/assets/screenshots/02-agent-running-trace.png` | Agent 运行中与 Trace 可观测过程 | TODO |
| `docs/assets/screenshots/03-memory-review-permission.png` | 记忆审查或权限确认流程 | TODO |
| `docs/assets/screenshots/04-plugin-permission-danger-dialog.png` | 插件权限与高风险确认弹窗 | TODO |
| `docs/assets/screenshots/05-eval-report-preview.png` | Eval Report 预览或测评说明 | TODO |
